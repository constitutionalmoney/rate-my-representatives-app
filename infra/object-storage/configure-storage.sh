...
mc anonymous set none local/rmr-public
mc anonymous set download local/rmr-public/approved-manifests
...
mc cp /opt/rmr/fixtures/approved-manifest.json \
  local/rmr-public/approved-manifests/synthetic-foundation.json
...
mc cp /opt/rmr/fixtures/private-object.txt \
  local/rmr-private/synthetic-private-object.txt

echo 'Object-storage buckets and isolated policies are ready.'
