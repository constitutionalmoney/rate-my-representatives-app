...
export const MODERATION_DECISION_SCHEMA = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://schemas.ratemyrepresentatives.com/moderation-decision.schema.json",
  "title": "ModerationDecisionV1",
  "description": "Restricted decision metadata with a separately controlled public projection; never raw evidence or review notes.",
  "type": "object",
  "additionalProperties": false,
  "required": [
    "schemaVersion",
  ...
  "properties": {
    "schemaVersion": {
      "const": "moderation-decision.v1"
    },
    "policyVersion": {
      "const": "moderation-due-process-policy.v1"
    },
    "dataMode": {
      "enum": [
        "synthetic",
    ...
    "review": {
      ...
      "properties": {
        ...
        "recusalOutcome": {
          "enum": [
            "no_recusal_required",
            "reassigned_after_recusal",
            "secondary_review_approved"
          ]
        },
        "independentOfOriginalDecision": {
          "type": "boolean"
      ...
      "allOf": [
        {
          "if": {
            "properties": {
              "state": {
                "const": "public_projection_approved"
              }
            },
            "required": [
              "state"
